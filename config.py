...
config.set('General','limit',15)

config.add_section('XBMC')
config.set('XBMC','sqlitePath','C:\Users\Dan.Moseley\AppData\Roaming\XBMC\userdata\Database\MyVideos75.db')

config.add_section('SickBeard')
config.set('SickBeard','sqlitePath','C:\Program Files (x86)\SickBeard\sickbeard.db')
